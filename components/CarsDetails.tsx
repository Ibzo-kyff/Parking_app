...
// import { favorisService } from './services/favorisService'; // Import du service favoris
...
//   // Vérifier si le véhicule est déjà dans les favoris au chargement
//   useEffect(() => {
...
//       if (isFavorite) {
//         // Retirer des favoris
//         const result = await favorisService.removeFromFavoris(vehicule.id);
//         if (result.success) {
//           setIsFavorite(false);
//           Alert.alert('Succès', result.message + ' ❤️');
//         } else {
//           Alert.alert('Erreur', result.message);
//         }
//       } else {
//         // Ajouter aux favoris
//         const result = await favorisService.addToFavoris(vehicule);
//         if (result.success) {
//           setIsFavorite(true);
...
//           isLoadingFavorite && styles.favoriteButtonDisabled
//         ]} 
//         onPress={toggleFavorite}
//         disabled={isLoadingFavorite}
//       >
//         {isLoadingFavorite ? (
//           <ActivityIndicator size="small" color={isFavorite ? "#FFF" : "#FF6F00"} />
//         ) : (
//           <FontAwesome5 
//             name="heart" 
//             size={24} 
...
//         {/* Bouton réservation seul maintenant */}
...
//     color: '#FF6F00'
//   },
//   // Bouton réserver seul maintenant
//   reserveButton: {
//     marginHorizontal: 16,
//     marginVertical: 16,
//     backgroundColor: '#FF6F00',
...
//         if (result.success) {
//           setIsFavorite(false);
//           // Pas d'alerte - changement silencieux
//         } else {
//           console.log('Erreur retrait favoris:', result.message);
//         }
//       } else {
//         // Ajouter aux favoris
//         const result = await favorisService.addToFavoris(vehicule);
...
//           // Pas d'alerte - changement silencieux
//         } else {
//           console.log('Info favoris:', result.message);
//         }
//       }
//     } catch (error) {
//       console.error('Erreur gestion favoris:', error);
